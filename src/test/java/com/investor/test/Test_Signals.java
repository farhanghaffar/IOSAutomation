...
public class Test_Signals extends BaseClass {
	...
	public void VerifySignalsSection() {
		...
		String [] signalNames = {"Value Creators","Income Generators","Coffee Can Investing","Bullish RSI","Rising Stars","Buffet-Graham Formula","Golden Crossover"};
		...
		ErrorCollector.verifyTrue(browsePage.isSignalsInfoIconClickable(),
				"Verified “i” icon is Clickable.");
		
		for(String signal: signalNames) {
			ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify <b>“"+signal+"”</b> signal is Displaying.");
	...
	public void ValueCreater_SignalsDetails() {
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify 'Market Cap' is selected by default in Signals sorting dropdown is displaying.");
		...
		ErrorCollector.verifyTrue(browsePage.verifySignalsDescriptionIsDisplaying("This Signal lists stocks with strong free cash flow indicators and revenue over the last 12 months"),
		...
		ErrorCollector.verifyTrue(browsePage.verifyLearnMoreButtonIsClickable(),
				"Verify Signal button is clickable.");
		...
		ErrorCollector.verifyTrue(browsePage.verifySortingFilterIsDisplaying("Market Price"),"Verified 'Market Price' filter is displaying.");
	...
	public void CoffeeCanInvesting_SignalsDetails() {
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify Signal description is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDescriptionIsDisplaying("The Coffee Can Investing approach refers to "),
				"Verify Signal description is displaying.");
	...
	public void CoffeeCanInvesting_SignalsDetails_NonPremiumUsers() {
		...
		ErrorCollector.extentLogInfo("<a target=\"_blank\" href=\"https://vestedfinance.atlassian.net/browse/QAA-898\"><font color=red>Click here to view reported bug</font></a>");
	...
	public void IncomeGenerators_SignalsDetails() {
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify Signal description 'This Signal lists companies with high dividend yields and strong free cash flow to support steady dividend payments' is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDescriptionIsDisplaying("This Signal lists companies with high dividend yields"),
				"Verify Signal description is displaying.");
	...
	public void BullishRSI_SignalsDetails() {
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify Signal description 'This Signal is based on the relative strength index (RSI) technical indicator. It employs filters that screen for stocks where the 14-day RSI crosses over 30, indicating a bullish pattern for the stock price' is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDescriptionIsDisplaying("This Signal is based on the relative strength index"),
				"Verify Signal description is displaying.");
	...
	public void RisingStars_SignalsDetails() {
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify Signal description 'This Signal provides you with a list of Small and Mid Cap companies that have good fundamentals and growth' is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDescriptionIsDisplaying("This Signal provides you with a list of Small and Mid Cap companies"),
				"Verify Signal description is displaying.");
	...
	public void BuffetGrahamFormula_SignalsDetails() {
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify Signal description 'The Buffet-Graham Formula is used to identify fundamentally strong companies that have good earning potential and are available at a good buying price' is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDescriptionIsDisplaying("The Buffet-Graham Formula is used to identify fundamentally strong companies"),
				"Verify Signal description is displaying.");
	...
	public void GoldenCrossover_SignalsDetails() {
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify Signal description 'A Golden Crossover is a bullish technical indicator. This Signal screens for companies whose stock price has formed a golden cross pattern' is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDescriptionIsDisplaying("A Golden Crossover is a bullish technical indicator."),
				"Verify Signal description is displaying.");
	...
	public void SignalPopUp_ExplorePage() {
		...
		ErrorCollector.verifyTrue(browsePage.verifySignalsInfoDialogIsDisplaying(),"Verified Signals info pop up is displaying.");

		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify 'X' is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsInfoDialogClosIconIsDisplaying(),"Verified 'X' is displaying.");

		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify 'X' is clickable.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsInfoDialogCloseIconIsClickable(),"Verified 'X' is clickable.");

		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify description 'Signals are lists of stocks pre-screened with fundamental strategies or technical indicators. The list of stocks for each Signal is generated every day using the latest data available on' is displaying.");
		...
		ErrorCollector.verifyFalse(browsePage.verifySignalsInfoDialogIsDisplaying(),"Verified Signals info pop up is closed.");
	...
	public void IncomeGenerator_SignalsDetails_NonPremiumUsers() {
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify Signal description is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDescriptionIsDisplaying("This Signal lists companies with high dividend yields and strong"),
				"Verify Signal description is displaying.");
	...
	public void IncomeGenerators_SignalsNameAndSymbolsOnDetailsScreen() {
		...
		for (int i=0;i<signalsDetails.size();i++) {
			...
			ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify stock name: '"+stockName+"' is available.");
			ErrorCollector.verifyTrue(browsePage.verifySignalStockNameAvailable(stockName),
					"Verified stock '"+stockName+"' is available.");

			ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify stock symbol: '"+stockSymbol+"' is available.");
	...
	public void SignalsDisclosure_ExplorePage() {
		...
		ErrorCollector.verifyTrue(browsePage.verifySignalsDisclosureDialogIsDisplaying(),"Verified Signals disclosure pop up is displaying.");

		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify 'X' is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDisclosureDialogClosIconIsDisplaying(),"Verified 'X' is displaying.");

		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify 'X' is clickable.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDisclosureDialogCloseIconIsClickable(),"Verified 'X' is clickable.");
		...
		waitTime(1000);
		ErrorCollector.verifyFalse(browsePage.verifySignalsDisclosureDialogIsDisplaying(),"Verified Signals disclosure pop up is closed.");
	...
	public void BullishRSI_SignalsNameAndSymbolsOnDetailsScreen() {
		...
		String signalName = "Bullish RSI";
		HashMap<String,String> signalsDetails = new HashMap<>();
		signalsDetails.put("Yelp Inc","YELP");
		signalsDetails.put("Oatly Group AB","OTLY");
		signalsDetails.put("Mirati Therapeutics, Inc","MRTX");
		signalsDetails.put("Sysco Corporation","SYY");
		signalsDetails.put("Intellia Therapeutics Inc","NTLA");
		signalsDetails.put("Design Therapeutics Inc","DSGN");
		signalsDetails.put("Arlo Technologies, Inc.","ARLO");
		signalsDetails.put("WIDEOPENWEST INC","WOW");
		signalsDetails.put("Stratasys Ltd.","SSYS");
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify Signals section is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsSectionIsDisplaying(),"Verify Signals section is displaying.");

		ErrorCollector.extentLogInfo("Step " + (++step) + " : Click on Signal: " + signalName);
		browsePage.clickOnSignalsWithScrolling(signalName);

		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify Signal detail page is displaying.");
		ErrorCollector.verifyTrue(browsePage.verifySignalsDetailsPageIsDisplaying(),"Verified Signal details page is displaying.");
		...
		for (int i=0;i<signalsDetails.size();i++) {
			...
			String stockSymbol = signalsDetails.get(stockName);
			ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify stock name: '"+stockName+"' is available.");
			ErrorCollector.verifyTrue(browsePage.verifySignalStockNameAvailable(stockName),"Verified stock '"+stockName+"' is available.");

			ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify stock symbol: '"+stockSymbol+"' is available.");
			ErrorCollector.verifyTrue(browsePage.verifySignalStockSymbolAvailable(stockSymbol),"Verified stock '"+stockSymbol+"' is available.");
		}
	}
...
//		signup.clickOnDoneButtonInModal();
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify 'Market Cap' is selected by default in sorting dropdown is displaying.");
		ErrorCollector.verifyEquals(browsePage.getSelectedValueOfSignalsSortingDropdown(),"Market Cap",
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify '"+signalName+"' signal stocks are sorted by 'Alphabetical' filter.");
		ErrorCollector.verifyEquals(names, sortedNames,"'"+signalName+"' signal are not sorted by names Alphabetically.");
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify '"+signalName+"' signal stocks are sorted by 'Symbol' filter.");
		ErrorCollector.verifyEquals(symbols, sortedSymbols,"'"+signalName+"' signal stocks are not sorted by names Symbol.");
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify '"+signalName+"' signal stocks are sorted by 'Market Price' filter.");
		ErrorCollector.verifyEquals(MarketPrice, sortedMarketPrices,"'"+signalName+"' signal are not sorted by market price.");
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify '"+signalName+"' signal stocks are sorted by 'Daily Change' filter.");
		ErrorCollector.verifyEquals(DailyChange, sortedDailyChange,"'"+signalName+"' signal are not sorted by Daily Change.");
		...
		ErrorCollector.extentLogInfo("Step " + (++step) + " : Verify '"+signalName+"' signal stocks are sorted by 'Market Cap' filter.");
		ErrorCollector.verifyEquals(marketCapitals, sortedMarketCapitals,"'"+signalName+"' signal are not sorted by market capital.");	
	}
