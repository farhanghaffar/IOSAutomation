...
public class BaseClass extends Utilities{
		...
		try {
			...
			if(!runOnBrowserStack) {
			 ...
			 //   capabilities.setCapability(IOSMobileCapabilityType.AUTO_ACCEPT_ALERTS, true);
			   ...
			   // capabilities.setCapability("udid", "CF4272F4-E744-41FB-9166-98D52DDDA972");
				...
				capabilities.setCapability("autoAcceptAlerts", "true");
				//capabilities.setCapability("browserstack.uploadMedia", new String[]{"media://be49274c18a796de12d92aa24963d5e2e695b7e9"});
	...
	Purpose : BaseClass is accessible to every TestClass. Hence shorter way to print message.
	Parameters : 
