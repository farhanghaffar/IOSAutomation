...
public class ExplorePage extends BaseClass {
	...
	@FindBy(xpath = "//XCUIElementTypeButton[contains(@name,'Profile, tab, ')]")
...
//	/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup[15]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup[3]/android.view.ViewGroup
	...
	@FindBy(xpath = "//XCUIElementTypeStaticText[@name='transactionsLabel'] | //XCUIElementTypeStaticText[@label='Transactions']")
	WebElement profile_TransactionsButton;

	@FindBy(xpath = "//XCUIElementTypeStaticText[@name='tradeConfirmationsLabel'] | //XCUIElementTypeStaticText[@label='Trade Confirmations']")
	WebElement profile_TradeConfirmation;

	@FindBy(xpath = "//XCUIElementTypeStaticText[@name='accountStatementsLabel'] | //XCUIElementTypeStaticText[@label='Account Statements']")
	WebElement profile_AccountStatement;
	

	@FindBy(xpath = "//XCUIElementTypeStaticText[@name='taxDocumentsLabel'] | //XCUIElementTypeStaticText[@name='Tax Documents']")
	...
	@FindBy(xpath = "//XCUIElementTypeOther[@name='selectPlanBtnPREMIUM'] | //XCUIElementTypeOther[@name=\"1 Year\"]//following-sibling::XCUIElementTypeOther")
	private WebElement priceGoPremiumPage;
	
	@FindBy(xpath = "//XCUIElementTypeStaticText[@name=\"goPremiumLabel\"]")
	...
	@FindBy(xpath = "//XCUIElementTypeStaticText[@name=\"WITHDRAW FUNDS\"]")
	...
	By etfSection = By.xpath("(//XCUIElementTypeStaticText[@name='renderScetionTitle'])[8]");
	...
	@FindBy(xpath="//XCUIElementTypeStaticText[@name='renderSectionRecommendedShowAllBtn'] | (//XCUIElementTypeStaticText[@name='renderScetionTitle' and @label='Signals'])[1]")
...
//		
	...
	public void clickOnDIYVestMenuButton() {
		waitForElementToBeClickable(diyVestMenu, 30);
...
//	}
	...
	public boolean verifyTransactionHeadingIsDisplaying() {
		waitForElementToBePresent(profile_TransactionsButton, 30);
		return isElementDisplayed(profile_TransactionsButton);
	}
	...
	public boolean verifyTradeConfirmationHeadingIsDisplaying() {
		waitForElementToBePresent(profile_TradeConfirmation, 30);
		return isElementDisplayed(profile_TradeConfirmation);
	}
	...
	public boolean verifyAccountStatementsHeadingIsDisplaying() {
		waitForElementToBePresent(profile_AccountStatement, 30);
		return isElementDisplayed(profile_AccountStatement);
	}
...
//			
	...
	public void scrollDownToETFSection() {
		IOSElement otc = (IOSElement) driver.findElement(etfSection);
		for(int i=0;i<10;i++){
			if(otc.isDisplayed()) {
				return;
			}
	...
	public boolean verifyETFSectionIsDisplaying() {
		return isElementDisplayed( driver.findElement(etfSection));
	}
