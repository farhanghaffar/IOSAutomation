...
public class FundTransferPage extends BaseClass {
	...
	@FindBy(xpath = "(//XCUIElementTypeStaticText[@name='Select Bank Country'])//following-sibling::XCUIElementTypeOther[@name='withdrawalBeneficiaryBankCountry'] | (//XCUIElementTypeStaticText[@name='Select Bank Country'])[last()]")
	...
	@FindBy(xpath = "//XCUIElementTypeOther[@name='Indian Bank chevron_right']")
	...
	@FindBy(xpath = "//XCUIElementTypeOther[@name=\"International Bank chevron_right\"]")
	...
	public void selectbankCountry(String bankCountry) {
		...
		waitTime(1000);
		clickWebElement(getDriver().findElement(By.xpath("(//XCUIElementTypeOther[contains(@name,'"+bankCountry+"')])[last()]")));
	}
