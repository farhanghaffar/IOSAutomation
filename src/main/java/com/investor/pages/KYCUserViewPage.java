...
//	@FindBy(id ="vestGraphMaxBtn")
	...
	@FindBy(xpath ="(//XCUIElementTypeOther[@name=\"Vertical scroll bar, 1 page Horizontal scroll bar, 1 page Vertical scroll bar, 2 pages Horizontal scroll bar, 1 page\"])[1]")
	...
	@FindBy(xpath = "(//XCUIElementTypeOther[@name='Vertical scroll bar, 1 page Horizontal scroll bar, 1 page'])[last()]")
	private WebElement multiAssetVestOverviewGraph;

	@FindBy(xpath = "//XCUIElementTypeStaticText[@name='vestCompareDialogVestName0']")
	private WebElement vestConservativeComparePrtfolioModal;

	@FindBy(xpath = "//XCUIElementTypeStaticText[@name='vestCompareDialogVestName1']")
	private WebElement vestModerateComparePrtfolioModal;

	@FindBy(xpath = "//XCUIElementTypeStaticText[@name='vestCompareDialogVestName2']")
	...
	public void clickOnVBNIXInfoIcon() {
		scrollDownToIOSElement(getDriver().findElement(By.xpath("//XCUIElementTypeStaticText[@name='vestDetailsComparingInfoIcon']")));
		waitTime(1000);
